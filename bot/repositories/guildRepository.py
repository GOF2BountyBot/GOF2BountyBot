...
class GuildRepository(SerializesToType[Dict[int, basedGuild.SerializedBasedGuildUnion]]):
    ...
    @classmethod
    def deserialize(cls, guildDBDict: Dict[int, basedGuild.SerializedBasedGuildUnion], dbReload=False, **kwargs) -> GuildRepository:
